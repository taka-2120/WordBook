...
//  WordVenture
//
//  Created by Yu Takahashi on 5/29/23.
//
...
class GADNativeViewController: UIViewController {
    ...
    func refreshAd() {
        ...
        let mediaViewOptions = GADNativeAdMediaAdLoaderOptions()
        mediaViewOptions.mediaAspectRatio = .square
        
        adLoader = GADAdLoader(
            adUnitID: adUnitID, rootViewController: self,
            adTypes: [.native], options: [adViewOptions, mediaViewOptions])
...
extension GADNativeViewController: GADNativeAdLoaderDelegate {
    ...
    func adLoader(_ adLoader: GADAdLoader, didReceive nativeAd: GADNativeAd) {
        ...
        nativeAdView.mediaView?.sizeToFit()
        nativeAdView.mediaView?.layer.cornerRadius = 10
